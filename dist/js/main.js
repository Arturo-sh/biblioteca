...
function reset_transaction_data() {
    ...
    $("#label_titulo_libro").text("");
    $("#label_fecha_prestamo").text("");
    $("#label_fecha_entrega").text("");
    $("#label_estado_prestamo").text("");
    $("#lista-libros").html("");
...
function set_transaction_data(response) {
    ...
    $("#label_estado_prestamo").text(data.transaccion_data[0].estado_prestamo);
    $(".btn-delete").attr("id", data.transaccion_data[0].id_transaccion);
    
    var librosData = data.libros_data; // Asigna los datos de los libros

    var listaLibros = $('#lista-libros');
    
    // Recorre los datos de los libros y agrega elementos li a la lista
