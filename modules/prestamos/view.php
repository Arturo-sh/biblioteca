                  ...
                  <div>
                    <div class='card-body row'>
                      <div class='form-group col-md-6'>
                        ...
                        <input type='hidden' class='form-control' id='label_id_transaccion' name='label_id_transaccion'>
                      ...
                      <div class='form-group col-md-12'>
                        <label for='titulo_libro'>Libro(s)</label>
                    ...
                    <div class='text-center mb-4'>
                      ...
                      <button mod='prestamos' class='btn btn-outline-danger btn-delete' data-dismiss='modal'>
